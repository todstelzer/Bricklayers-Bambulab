...
def process_gcode(input_file, layer_height, extrusion_multiplier):
    ...
    for line in lines:
        ...
        elif ";TYPE:Perimeter" in line or ";TYPE:Inner wall" in line or "; FEATURE: Inner wall" in line:
            perimeter_type = "internal"
            inside_perimeter_block = False
            logging.info(f"Internal perimeter block started at layer {current_layer}")
        elif ";TYPE:" in line or "; FEATURE:" in line:  # Reset for other types
            perimeter_type = None
            inside_perimeter_block = False

        # Group lines into perimeter blocks
        if perimeter_type == "external" and line.startswith("G1") and "X" in line and "Y" in line and "E" in line:
        ...
        elif perimeter_type == "external" and line.startswith("G1") and "X" in line and "Y" in line and "F" in line:  # End of perimeter block
            inside_perimeter_block = False
